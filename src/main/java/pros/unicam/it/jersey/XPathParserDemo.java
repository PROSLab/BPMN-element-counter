...
//        nOfExtensionElements = nodesExtension.getLength();
            ...
            row.createCell(352).setCellValue(nChoreographyTaskMultipleInstance);
            row.createCell(353).setCellValue(nChoreographyTaskParallelInstance);
            row.createCell(354).setCellValue(nChoreographyTaskLoop);
            ...
            row.createCell(359).setCellValue(nChoreographySubprocessCollapsedCall);
            row.createCell(360).setCellValue(nChoreographySubprocessCollapsedCallMultipleInstance);
            row.createCell(361).setCellValue(nChoreographySubprocessCollapsedCallParallelInstance);
            row.createCell(362).setCellValue(nChoreographySubprocessCollapsedCallLoop);
            row.createCell(363).setCellValue(nChoreographySubprocessExpanded);
            row.createCell(364).setCellValue(nChoreographySubprocessExpandedMultipleInstance);
            row.createCell(365).setCellValue(nChoreographySubprocessExpandedParallelInstance);
            row.createCell(366).setCellValue(nChoreographySubprocessExpandedLoop);
            row.createCell(367).setCellValue(nChoreographyParticipant);
            row.createCell(368).setCellValue(nChoreographyParticipantMultiple);       
            row.createCell(369).setCellValue(nConversationNone);
            row.createCell(370).setCellValue(nConversationSubProcess);
            row.createCell(371).setCellValue(nConversationCall);
            row.createCell(372).setCellValue(nConversationSubProcessCall);
            row.createCell(373).setCellValue(nConversationLink);
            row.createCell(374).setCellValue(nAssociationCompensate);
            row.createCell(375).setCellValue(nAssociationUndirected);
            row.createCell(376).setCellValue(nAssociationUnidirectional);        
            row.createCell(377).setCellValue(nAssociationBidirectional);
            row.createCell(378).setCellValue(nAssociationDataOutput);
            row.createCell(379).setCellValue(nAssociationDataInput);
            row.createCell(380).setCellValue(nCondition);
            row.createCell(381).setCellValue(nGroup);
            ...
            if(ConsiderExtendedSubProcess && nGeneralSubProcess>0) {
                ...
                rowhead2.createCell(352).setCellValue("nChoreographyTaskMultipleInstance");
                rowhead2.createCell(353).setCellValue("nChoreographyTaskParallelInstance");
                ...
                row2.createCell(316).setCellValue(nIntermediateThrowNoneEventDefinition);
                row2.createCell(317).setCellValue(nIntermediateThrowMessageEventDefinition);
                row2.createCell(318).setCellValue(nIntermediateThrowEscalationEventDefinition);
                row2.createCell(319).setCellValue(nIntermediateThrowLinkEventDefinition);
                row2.createCell(320).setCellValue(nIntermediateThrowSignalEventDefinition);
                row2.createCell(321).setCellValue(nIntermediateThrowCompensateEventDefinition);
                row2.createCell(322).setCellValue(nIntermediateThrowMultipleParallelEventDefinition);
                ...
                row2.createCell(352).setCellValue(nChoreographyTaskMultipleInstance);
                row2.createCell(353).setCellValue(nChoreographyTaskParallelInstance);
                row2.createCell(354).setCellValue(nChoreographyTaskLoop);
                row2.createCell(355).setCellValue(nChoreographySubprocessCollapsed);
                row2.createCell(356).setCellValue(nChoreographySubprocessCollapsedMultipleInstance);
                row2.createCell(357).setCellValue(nChoreographySubprocessCollapsedParallelInstance);
                row2.createCell(358).setCellValue(nChoreographySubprocessCollapsedLoop);
                row2.createCell(359).setCellValue(nChoreographySubprocessCollapsedCall);
                row2.createCell(360).setCellValue(nChoreographySubprocessCollapsedCallMultipleInstance);
                row2.createCell(361).setCellValue(nChoreographySubprocessCollapsedCallParallelInstance);
                row2.createCell(362).setCellValue(nChoreographySubprocessCollapsedCallLoop);
                row2.createCell(363).setCellValue(nChoreographySubprocessExpanded);
                row2.createCell(364).setCellValue(nChoreographySubprocessExpandedMultipleInstance);
                row2.createCell(365).setCellValue(nChoreographySubprocessExpandedParallelInstance);
                row2.createCell(366).setCellValue(nChoreographySubprocessExpandedLoop);
                row2.createCell(367).setCellValue(nChoreographyParticipant);
                row2.createCell(368).setCellValue(nChoreographyParticipantMultiple);       
                row2.createCell(369).setCellValue(nConversationNone);
                row2.createCell(370).setCellValue(nConversationSubProcess);
                row2.createCell(371).setCellValue(nConversationCall);
                row2.createCell(372).setCellValue(nConversationSubProcessCall);
                row2.createCell(373).setCellValue(nConversationLink);
                row2.createCell(374).setCellValue(nAssociationCompensate);
                row2.createCell(375).setCellValue(nAssociationUndirected);
                row2.createCell(376).setCellValue(nAssociationUnidirectional);        
                row2.createCell(377).setCellValue(nAssociationBidirectional);
                row2.createCell(378).setCellValue(nAssociationDataOutput);
                row2.createCell(379).setCellValue(nAssociationDataInput);
                row2.createCell(380).setCellValue(nCondition);
