    ...
    if(".bpmn" in files):
        ...
        with open(sys.argv[2],'a', newline='') as file:
            ...
            writer.writerow([fileName,bpmnModeler,nTask,nSendTask,nUserTask,nManualTask,nBusinessRuleTask,nServiceTask,nScriptTask,nCallActivity
                        ...
                        ,nBoundaryMessageEventNonInt,nGroup,nMessageFlow,nSequenceFlow,nPool,nVerticalLane,nVerticalPool,
                        nChoreographyTask,nChoreographyParticipant,nChoreographySubprocess,nITSystem])
